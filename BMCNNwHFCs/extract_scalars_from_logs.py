...
def go(summary_dirs, output_dir):
    ...
    dirs = ['20211103121518']
    files = ['../logs_ms0/20211103121518/events.out.tfevents.1635956118.jj-X580VD.155273.5.v2']
    ...
    for k in scalar_data.keys():
        ...
        D = np.max([len(dirs),1])
        vals = np.full((events_count, D), None)
        for x in range(D):
...
if __name__ == '__main__':
    ...
    p.add_argument("--event_data_dir", default=r"../logs_ms0/20211103121518")
    p.add_argument("--output_dir", default=r"../logs_ms0/20211103121518")
    a = p.parse_args()
